package com.testando.gateway.web.rest;
...
public class AuthResource {
    ...
    public ResponseEntity<OAuth2AccessToken> authenticate(HttpServletRequest request, HttpServletResponse response, @RequestBody
        Map<String, String> params, @RequestHeader("Authorization") String autorization) {
        return authenticationService.authenticate(request, response, params, autorization);
    }
