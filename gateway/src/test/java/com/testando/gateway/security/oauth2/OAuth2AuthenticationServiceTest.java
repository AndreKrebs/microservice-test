...
import com.testando.gateway.config.oauth2.OAuth2Properties;
import com.testando.gateway.web.filter.RefreshTokenFilter;
...
//        request.addHeader("Authorization", CLIENT_AUTHORIZATION);
        ...
        authenticationService.authenticate(request, response, params, CLIENT_AUTHORIZATION);
